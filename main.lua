...
if game.CoreGui:FindFirstChild('SyntaxLib') then
    game.CoreGui:FindFirstChild('SyntaxLib'):Destroy()
    destroyed = true
end
...
local SyntaxLib = Instance.new("ScreenGui")

SyntaxLib.Name = "SyntaxLib"

protect_gui(SyntaxLib)
...
local function AddBlur()
    ...
    blur.Name = "SyntaxBlur"
    blur.Size = 10
    blur.Parent = game:GetService("Lighting")
    return blur
end

-- Modify main library functions
function library:Destroy()
    local lighting = game:GetService("Lighting")
    local blur = lighting:FindFirstChild("SyntaxBlur")
...
function library:Hide()
    SyntaxLib.Enabled = not SyntaxLib.Enabled
    
    -- Handle blur effect
    local lighting = game:GetService("Lighting")
    if SyntaxLib.Enabled then
        if not lighting:FindFirstChild("SyntaxBlur") then
            AddBlur()
        end
    else
        local blur = lighting:FindFirstChild("SyntaxBlur")
...
function library:Window(name) 
    ...
    UiWindow.Parent = SyntaxLib
    UiWindow.BackgroundColor3 = Color3.fromRGB(46, 52, 64)
    UiWindow.BorderColor3 = Color3.fromRGB(59, 66, 82)
    UiWindow.Position = UDim2.new(0, xOffset, 0, 20)
    UiWindow.Size = UDim2.new(0, 207, 0, 33)
    UiWindow.ZIndex = 4 + zindex
    UiWindow.Active = true
    UiWindow.BackgroundTransparency = 0.1
    Dragify(UiWindow)
    ...
    Header.BackgroundColor3 = Color3.fromRGB(59, 66, 82)
    Header.BorderColor3 = Color3.fromRGB(67, 76, 94)
    ...
    HeaderText.TextColor3 = Color3.fromRGB(236, 239, 244)
    ...
    Minimise.BackgroundColor3 = Color3.fromRGB(59, 66, 82)
    Minimise.BorderColor3 = Color3.fromRGB(67, 76, 94)
    ...
    Minimise.Text = "_"
    Minimise.TextColor3 = Color3.fromRGB(236, 239, 244)
    ...
    -- Add transparency to main elements
    UiWindow.BackgroundTransparency = 0.1
    Header.BackgroundTransparency = 0.1
    ...
    function functions:Button(name, callback)
        ...
        Button.BackgroundColor3 = Color3.fromRGB(67, 76, 94)
        Button.BorderColor3 = Color3.fromRGB(76, 86, 106)
    ...
    function functions:Label(text, color)
        ...
        Label.BackgroundTransparency = 1.000        Label.BorderColor3 = Color3.fromRGB(27, 42, 53)
    ...
    function functions:Toggle(text, on, callback)
        ...
        ToggleButton.BackgroundColor3 = Color3.fromRGB(67, 76, 94)
        ToggleButton.BorderColor3 = Color3.fromRGB(76, 86, 106)
        ...
        ToggleFiller.BackgroundColor3 = Color3.fromRGB(143, 188, 187)
        ToggleFiller.BorderColor3 = Color3.fromRGB(67, 76, 94)
...
-- Modify the CreateNotification function to match the new syntax
function library.Notify(properties)
    ...
    if not library.NotifGui then
        library.NotifGui = Instance.new("ScreenGui")
        library.NotifGui.Name = "SyntaxNotifications"
        protect_gui(library.NotifGui)
        
        library.NotifContainer = Instance.new("Frame")
        library.NotifContainer.Name = "NotificationContainer"
        library.NotifContainer.Position = UDim2.new(0, 20, 0.5, -20)
        library.NotifContainer.Size = UDim2.new(0, 300, 0.5, 0)
        library.NotifContainer.BackgroundTransparency = 1
        library.NotifContainer.Parent = library.NotifGui
    end

    -- Create notification frame with Nordic theme
    local notif = Instance.new("Frame")
    notif.Name = "Notification"
    notif.Size = UDim2.new(1, 0, 0, 80)
    notif.Position = UDim2.new(-1, 0, 0, #ActiveNotifications * (80 + NotifPadding))
    notif.BackgroundColor3 = Color3.fromRGB(46, 52, 64)
    notif.BackgroundTransparency = 0.1
    notif.BorderColor3 = Color3.fromRGB(59, 66, 82)
    notif.Parent = library.NotifContainer

    -- Title with Nord theme
    ...
    -- Description with Nord theme
    local descLabel = Instance.new("TextLabel")
    descLabel.Name = "Description"
    descLabel.Size = UDim2.new(1, -20, 1, -40)
    descLabel.Position = UDim2.new(0, 10, 0, 35)
    descLabel.BackgroundTransparency = 1
    descLabel.Font = Enum.Font.Gotham
    descLabel.TextSize = 14
    descLabel.TextColor3 = Color3.fromRGB(216, 222, 233)
    ...
    -- Slide in animation
    local tweenIn = TweenService:Create(notif, 
        TweenInfo.new(0.5, Enum.EasingStyle.Quint, Enum.EasingDirection.Out),
        {Position = UDim2.new(0, 0, 0, #ActiveNotifications * (80 + NotifPadding))}
    )
    tweenIn:Play()

    -- Fade out and remove after duration
    task.delay(duration, function()
        local tweenOut = TweenService:Create(notif,
            TweenInfo.new(0.5, Enum.EasingStyle.Quint, Enum.EasingDirection.Out),
        ...
        tweenOut.Completed:Connect(function()
            ...
            for i, notification in ipairs(ActiveNotifications) do
                TweenService:Create(notification,
                    ...
                    {Position = UDim2.new(0, 0, 0, (i-1) * (80 + NotifPadding))}
                ):Play()
            end
        end)
    end)
